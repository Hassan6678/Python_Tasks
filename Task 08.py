...
# day = int(input("Enter day (between 1 t0 31) : "))
#
# print("The person was born on a", (BirthDay(year, month, day)))
#
# '''
# • The calendar of the month of the birthday in 2020. Make sure that the
# columns (of the days of the week and the days) line up nicely.
# '''
#
# import calendar
